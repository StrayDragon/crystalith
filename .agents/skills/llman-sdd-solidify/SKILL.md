...
- **Framework-agnostic**: solidify does NOT scan `tests/bdd_steps.rs` or any BDD framework's step bindings. Whether a scenario is _executable_ at runtime is decided by `bdd.run_command`.
