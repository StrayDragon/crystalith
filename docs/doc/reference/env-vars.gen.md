...
- `FIRECRAWL_API_KEY`
- `JINA_API_KEY`
- `OMLX_OPENAI_API_BASE`
- `OMLX_OPENAI_DEFAULT_CHAT_MODEL`
- `OMLX_OPENAI_DEFAULT_EMBEDDING_MODEL`
- `OPENAI_BASE_URL`
- `POSTGRES_PASSWORD`
- `TUFA_OPENAI_API_HOST`
- `TUFA_OPENAI_DEFAULT_CHATMODEL`
