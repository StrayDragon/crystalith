# crystalith
A client library for accessing Crystalith
...
```python
from crystalith import AuthenticatedClient
...
```python
from crystalith.models import MyDataModel
from crystalith.api.my_tag import get_my_data_model
from crystalith.types import Response
...
1. Any endpoint which did not have a tag will be in `crystalith.api.default`
