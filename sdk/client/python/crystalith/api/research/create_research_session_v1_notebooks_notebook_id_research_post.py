...
from ...models.research_session_create import ResearchSessionCreate
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ResearchSessionResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        notebook_id (int):
        body (ResearchSessionCreate): Request model to create a research session.
