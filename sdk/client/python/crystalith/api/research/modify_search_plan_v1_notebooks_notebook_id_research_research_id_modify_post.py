...
from ...models.modify_request import ModifyRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/notebooks/{notebook_id}/research/{research_id}/modify".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        notebook_id (int):
        research_id (int):
        body (ModifyRequest): Request to modify a search plan.
