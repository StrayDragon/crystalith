...
from ...models.extractors_list_response import ExtractorsListResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/notebooks/{notebook_id}/sources/extractors".format(
...
) -> ExtractorsListResponse | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = ExtractorsListResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ExtractorsListResponse | HTTPValidationError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ExtractorsListResponse | HTTPValidationError
    """
