...
T = TypeVar("T", bound="SlideDraftCreate")


@_attrs_define
class SlideDraftCreate:
    """
    Attributes:
        title (None | str | Unset):
        prompt (None | str | Unset):
        engine (str | Unset): Rendering engine (default: slidev) Default: 'slidev'.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slide_draft_create.additional_properties = d
        return slide_draft_create
