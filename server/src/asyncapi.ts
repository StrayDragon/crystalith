  ...
  events: [
    {
      ...
      payload: { type: "object", properties: { session_id: { type: "integer" }, plan: { type: "object" } } },
    },
    {
      name: "search_result",
      description: "A web search result was retrieved.",
      payload: { type: "object", properties: { session_id: { type: "integer" }, result: { type: "object" } } },
    },
    {
      name: "analysis",
      description: "Analysis result for the current iteration.",
      payload: { type: "object", properties: { session_id: { type: "integer" }, analysis: { type: "object" } } },
    },
    {
      name: "done",
