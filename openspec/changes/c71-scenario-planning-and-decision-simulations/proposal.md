...
- 让这条线与 `c25`、`c30`、`c49` 形成闭环: 目标定义问题，program 推进执行，scenario 负责比较方案。
...
- Dependencies：建议接在 `c25-outcome-goals-and-impact-tracking`、`c30-portfolio-level-agent-programs`、`c49-charts-dashboards-and-data-storytelling`、`c46-sandboxed-compute-cells-and-kernel-runtime`、`c40-notebook-content-model-and-block-editor` 之后。
