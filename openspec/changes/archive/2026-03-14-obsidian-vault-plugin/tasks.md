...
- [x] 3.1 在 Sources 面板增加通用连接器入口，而不是“导入文件夹”入口
- [x] 3.2 实现宿主内置的连接参数表单与快照预览 UI
- [x] 3.3 实现目录 / 文件范围选择 UI，并清晰展示当前导入范围
- [x] 3.4 实现宿主内置的 `sync_check` 结果展示与确认同步交互
- [x] 3.5 实现通用导入进度、错误提示、诊断与恢复指引展示
