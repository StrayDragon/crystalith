...
const ZH_CN_MESSAGES = {
  ...
  'workspace.onboarding.connecting_description': '首次加载可能需要几秒；若长时间无响应，请确认后端服务已启动。',
  ...
  'workspace.onboarding.no_sources_description': '上传文件、从 URL 导入，或先做一次搜索，把内容放进当前笔记本。',
  ...
  'workspace.onboarding.no_session_description': '有了来源后，创建会话开始提问；也可以直接打开 Studio 生成输出。',
