 ...
 * List Commands
 */
export const listCommandsV1CommandsGet = <ThrowOnError extends boolean = false>(options?: Options<ListCommandsV1CommandsGetData, ThrowOnError>) => (options?.client ?? client).get<ListCommandsV1CommandsGetResponses, unknown, ThrowOnError>({ url: '/v1/commands', ...options });
 ...
 * Post Ui Event
 */
export const postUiEventV1NotebooksNotebookIdSessionsSessionIdUiEventPost = <ThrowOnError extends boolean = false>(options: Options<PostUiEventV1NotebooksNotebookIdSessionsSessionIdUiEventPostData, ThrowOnError>) => (options.client ?? client).post<PostUiEventV1NotebooksNotebookIdSessionsSessionIdUiEventPostResponses, PostUiEventV1NotebooksNotebookIdSessionsSessionIdUiEventPostErrors, ThrowOnError>({
 ...
 * Get Ui State
 */
export const getUiStateV1NotebooksNotebookIdSessionsSessionIdUiStateGet = <ThrowOnError extends boolean = false>(options: Options<GetUiStateV1NotebooksNotebookIdSessionsSessionIdUiStateGetData, ThrowOnError>) => (options.client ?? client).get<GetUiStateV1NotebooksNotebookIdSessionsSessionIdUiStateGetResponses, GetUiStateV1NotebooksNotebookIdSessionsSessionIdUiStateGetErrors, ThrowOnError>({ url: '/v1/notebooks/{notebook_id}/sessions/{session_id}/ui/state', ...options });
 ...
 * Apply Import Scope
 */
export const applyImportScopeV1NotebooksNotebookIdSourceConnectorBindingsBindingIdImportScopePost = <ThrowOnError extends boolean = false>(options: Options<ApplyImportScopeV1NotebooksNotebookIdSourceConnectorBindingsBindingIdImportScopePostData, ThrowOnError>) => (options.client ?? client).post<ApplyImportScopeV1NotebooksNotebookIdSourceConnectorBindingsBindingIdImportScopePostResponses, ApplyImportScopeV1NotebooksNotebookIdSourceConnectorBindingsBindingIdImportScopePostErrors, ThrowOnError>({
 ...
 * Snapshot Binding
 */
export const snapshotBindingV1NotebooksNotebookIdSourceConnectorBindingsBindingIdSnapshotPost = <ThrowOnError extends boolean = false>(options: Options<SnapshotBindingV1NotebooksNotebookIdSourceConnectorBindingsBindingIdSnapshotPostData, ThrowOnError>) => (options.client ?? client).post<SnapshotBindingV1NotebooksNotebookIdSourceConnectorBindingsBindingIdSnapshotPostResponses, SnapshotBindingV1NotebooksNotebookIdSourceConnectorBindingsBindingIdSnapshotPostErrors, ThrowOnError>({ url: '/v1/notebooks/{notebook_id}/source-connector-bindings/{binding_id}/snapshot', ...options });

/**
 * Sync Check Binding
 */
export const syncCheckBindingV1NotebooksNotebookIdSourceConnectorBindingsBindingIdSyncCheckPost = <ThrowOnError extends boolean = false>(options: Options<SyncCheckBindingV1NotebooksNotebookIdSourceConnectorBindingsBindingIdSyncCheckPostData, ThrowOnError>) => (options.client ?? client).post<SyncCheckBindingV1NotebooksNotebookIdSourceConnectorBindingsBindingIdSyncCheckPostResponses, SyncCheckBindingV1NotebooksNotebookIdSourceConnectorBindingsBindingIdSyncCheckPostErrors, ThrowOnError>({ url: '/v1/notebooks/{notebook_id}/source-connector-bindings/{binding_id}/sync-check', ...options });

/**
 * Apply Sync Check
 */
export const applySyncCheckV1NotebooksNotebookIdSourceConnectorBindingsBindingIdSyncCheckApplyPost = <ThrowOnError extends boolean = false>(options: Options<ApplySyncCheckV1NotebooksNotebookIdSourceConnectorBindingsBindingIdSyncCheckApplyPostData, ThrowOnError>) => (options.client ?? client).post<ApplySyncCheckV1NotebooksNotebookIdSourceConnectorBindingsBindingIdSyncCheckApplyPostResponses, ApplySyncCheckV1NotebooksNotebookIdSourceConnectorBindingsBindingIdSyncCheckApplyPostErrors, ThrowOnError>({
 ...
 */
export const listSourceConnectorsV1NotebooksNotebookIdSourceConnectorsGet = <ThrowOnError extends boolean = false>(options: Options<ListSourceConnectorsV1NotebooksNotebookIdSourceConnectorsGetData, ThrowOnError>) => (options.client ?? client).get<ListSourceConnectorsV1NotebooksNotebookIdSourceConnectorsGetResponses, ListSourceConnectorsV1NotebooksNotebookIdSourceConnectorsGetErrors, ThrowOnError>({ url: '/v1/notebooks/{notebook_id}/source-connectors', ...options });

/**
 * Create Connector Binding
 */
export const createConnectorBindingV1NotebooksNotebookIdSourceConnectorsConnectorIdBindingsPost = <ThrowOnError extends boolean = false>(options: Options<CreateConnectorBindingV1NotebooksNotebookIdSourceConnectorsConnectorIdBindingsPostData, ThrowOnError>) => (options.client ?? client).post<CreateConnectorBindingV1NotebooksNotebookIdSourceConnectorsConnectorIdBindingsPostResponses, CreateConnectorBindingV1NotebooksNotebookIdSourceConnectorsConnectorIdBindingsPostErrors, ThrowOnError>({
...
/**
 * Patch Extractors Policy
 */
export const patchExtractorsPolicyV1NotebooksNotebookIdSourcesExtractorsPatch = <ThrowOnError extends boolean = false>(options: Options<PatchExtractorsPolicyV1NotebooksNotebookIdSourcesExtractorsPatchData, ThrowOnError>) => (options.client ?? client).patch<PatchExtractorsPolicyV1NotebooksNotebookIdSourcesExtractorsPatchResponses, PatchExtractorsPolicyV1NotebooksNotebookIdSourcesExtractorsPatchErrors, ThrowOnError>({
 ...
 * List Prompt Presets
 */
export const listPromptPresetsV1PromptPresetsGet = <ThrowOnError extends boolean = false>(options?: Options<ListPromptPresetsV1PromptPresetsGetData, ThrowOnError>) => (options?.client ?? client).get<ListPromptPresetsV1PromptPresetsGetResponses, unknown, ThrowOnError>({ url: '/v1/prompt-presets', ...options });

/**
 * Create Prompt Preset
 */
export const createPromptPresetV1PromptPresetsPost = <ThrowOnError extends boolean = false>(options: Options<CreatePromptPresetV1PromptPresetsPostData, ThrowOnError>) => (options.client ?? client).post<CreatePromptPresetV1PromptPresetsPostResponses, CreatePromptPresetV1PromptPresetsPostErrors, ThrowOnError>({
 ...
 */
export const deletePromptPresetV1PromptPresetsPresetIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeletePromptPresetV1PromptPresetsPresetIdDeleteData, ThrowOnError>) => (options.client ?? client).delete<DeletePromptPresetV1PromptPresetsPresetIdDeleteResponses, DeletePromptPresetV1PromptPresetsPresetIdDeleteErrors, ThrowOnError>({ url: '/v1/prompt-presets/{preset_id}', ...options });

/**
 * Update Prompt Preset
 */
export const updatePromptPresetV1PromptPresetsPresetIdPatch = <ThrowOnError extends boolean = false>(options: Options<UpdatePromptPresetV1PromptPresetsPresetIdPatchData, ThrowOnError>) => (options.client ?? client).patch<UpdatePromptPresetV1PromptPresetsPresetIdPatchResponses, UpdatePromptPresetV1PromptPresetsPresetIdPatchErrors, ThrowOnError>({
