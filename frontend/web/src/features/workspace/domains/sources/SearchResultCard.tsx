...
import { Checkbox, Typography, IconButton, Menu, MenuHandler, MenuList, MenuItem } from '@material-tailwind/react';
import {
  Language as WebIcon,
...
const SearchResultCard = forwardRef<HTMLDivElement, SearchResultCardProps>(
  ({ result, isSelected, onToggle, onExpand, onAddAsLink, onAddWithFetch, compact = false }, ref) => {
    const hostname = (() => {
      try {
