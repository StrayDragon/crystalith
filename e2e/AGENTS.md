...
**Production deep-research parity** is `p0-eden-lab.spec.ts` (Eden, `VITE_LAB_FIXTURE` unset). Fixture-only
...
| Lab mode        | Eden default; fixture via `VITE_LAB_FIXTURE=1` | **Eden only** (`VITE_LAB_FIXTURE` cleared)        |
