/**
 * Mirror of apps/web/src/shared/testids.ts for Playwright ESM loading.
 * Keep in sync with web SSOT (Playwright 1.61 cannot named-import outside-package .ts).
 */
/**
...
export const TestIds = {
  ...
  topbarSearchTabFast: 'topbar-search-tab-fast',
  topbarSearchTabDeep: 'topbar-search-tab-deep',
  ...
  researchCanvasSettings: 'research-canvas-settings',
  researchCanvasLayoutTb: 'research-canvas-layout-tb',
  researchCanvasLayoutLr: 'research-canvas-layout-lr',
  researchCanvasMinimap: 'research-canvas-minimap',
  researchNodeInspector: 'research-node-inspector',
  researchNodePatchQuery: 'research-node-patch-query',
  researchNodePatchStatus: 'research-node-patch-status',
  researchNodePatchSave: 'research-node-patch-save',
  researchNodeChatInput: 'research-node-chat-input',
  researchNodeChatSend: 'research-node-chat-send',
  researchNodeChatProposal: 'research-node-chat-proposal',
  researchNodeChatAccept: 'research-node-chat-accept',
  researchProgressPanel: 'research-progress-panel',
  researchRevisionPanel: 'research-revision-panel',
  researchRevisionSave: 'research-revision-save',
  researchRevisionRestore: 'research-revision-restore',
  researchWorkingToggle: 'research-working-toggle',
