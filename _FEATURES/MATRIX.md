...
| —                               | —               | `GET/POST /v2/refine*`                                                 | api-only | 保留 — RefinePanel UI 已移除（2026-07-17）；API 仍可用   |
...
| —                               | —               | `GET/POST /v2/eval/*` (8 endpoints)                                    | api-only | 保留 — API-only，有 quality-and-regression r11；无 UI/CI |
