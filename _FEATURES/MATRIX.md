...
用户 UI 功能与 Server 路由映射。`Status`: **active** = 主路径挂载；**orphan** = 有代码无入口；**api-only** = 仅 API。
...
| `output-queue-jobs`             | 任务队列         | `GET /v2/notebooks/:nid/tasks`, `GET /v2/tasks/:id`                    | active   | 待盘点 |
| `output-fallback-retry`         | 降级重试         | `POST /v2/outputs`                                                     | active   | 待盘点 |
| `generic-output-renderer`       | 通用渲染         | `GET /v2/outputs/types`                                                | active   | 待盘点 |
| `output-note-type-paragraph`    | PARAGRAPH        | `POST /v2/refine`, `POST /v2/outputs`                                  | active   | 待盘点 |
| `output-note-type-bullets`      | BULLETS          | `POST /v2/refine`, `POST /v2/outputs`                                  | active   | 待盘点 |
| `output-note-type-structured`   | STRUCTURED       | `POST /v2/refine`                                                      | active   | 待盘点 |
...
| `audio-player-orphan`           | AudioPlayer      | —                                                                      | orphan   | 待盘点 |
| `video-player-orphan`           | VideoPlayer      | —                                                                      | orphan   | 待盘点 |
| `answer-card-orphan`            | AnswerCard       | `POST /v2/qa` (stats)                                                  | orphan   | 待盘点 |
| `barchart-card-orphan`          | BarChartCard     | `POST /v2/qa` (stats)                                                  | orphan   | 待盘点 |
| `datatable-card-orphan`         | DataTableCard    | `POST /v2/qa` (stats)                                                  | orphan   | 待盘点 |
| `tool-action-card-orphan`       | ToolActionCard   | `POST /v2/qa/stream`                                                   | orphan   | 待盘点 |
| `json-fallback-card-orphan`     | JsonFallbackCard | —                                                                      | orphan   | 待盘点 |
| `use-tasks-hook-unused`         | useTasks         | `GET .../tasks`                                                        | orphan   | 待盘点 |
| `refine-templates-data`         | Refine 模板数据  | —                                                                      | orphan   | 待盘点 |
| `dev-payload-warnings`          | DEV 警告         | —                                                                      | orphan   | 待盘点 |
| —                               | —                | `GET /v2/qa/presets`                                                   | api-only | 待盘点 |
| —                               | —                | `POST /v2/qa` (非流式)                                                 | api-only | 待盘点 |
| —                               | —                | `GET /sources/parsers`                                                 | api-only | 待盘点 |
| —                               | —                | `POST /v2/tasks/:id/cancel`                                            | api-only | 待盘点 |
| —                               | —                | `GET /v2/models/:modelId`, `GET /v2/models/providers`                  | api-only | 待盘点 |
| —                               | —                | `GET/POST /v2/eval/*` (8 endpoints)                                    | api-only | 待盘点 |
| —                               | —                | `GET/POST /v2/strategies`, `.../notebooks/:nid/strategies`             | api-only | 待盘点 |
