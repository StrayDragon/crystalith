...
export const TestIds = {
  ...
  researchLabStreamRetry: 'research-lab-stream-retry',
  ...
  researchLabAddBudget: 'research-lab-add-budget',
  researchLabPartialCompletionBanner: 'research-lab-partial-completion-banner',
