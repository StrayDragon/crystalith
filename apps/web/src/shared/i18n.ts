...
const ZH_CN_MESSAGES = {
  ...
  'sources.research.create_failed': '创建研究失败',
  'sources.research.detail_fetch_failed': '获取研究详情失败',
  'sources.research.resume_failed': '继续研究失败',

  'research.desk.title': '深度研究',
  'research.desk.require_notebook': '请先创建笔记本',
  'research.desk.disconnected': '未连接到后端服务，暂不支持深度研究',
  'research.desk.topic_placeholder': '输入研究主题…',
  ...
  'research.desk.queue_empty': '暂无研究任务',

  'research.depth.shallow': '浅',
  'research.depth.medium': '中',
  'research.depth.deep': '深',

  'research.status.queued': '排队中',
  'research.status.running': '进行中',
  'research.status.awaiting_confirm': '待确认',
  'research.status.completed': '已完成',
  'research.status.failed': '失败',
  'research.status.cancelled': '已取消',

  'research.detail.aria': '深度研究详情',
  'research.detail.expand_draft': '展开报告草稿',
  'research.detail.collapse_draft': '折叠报告草稿',
  'research.detail.no_report': '暂无报告',
  'research.detail.show_graph_readonly': '查看研究图（只读）',
  'research.detail.hide_graph': '隐藏研究图',

  'research.action.cancel': '取消',
  'research.convert.to_note': '转为笔记',
  'research.convert.to_source': '转为来源',

  'research.m1.budget': '预算将尽，请确认下一步',
  'research.m1.expand_branch': '检测到扩支路，请确认',
  'research.m1.continue': '继续',
  'research.m1.finish_report': '生成报告',
  'research.m1.approve_branch': '批准支路',
  'research.m1.skip_branch': '跳过支路',

  'research.inspector.fork': 'Fork',
  'research.inspector.prune': '剪枝',
  'research.inspector.fork_hint': 'Fork 提示（可选）',
  'research.inspector.fork_hint_placeholder': '可选方向说明',
  'research.inspector.fork_confirm': '确认从此节点 fork？',
  'research.inspector.prune_confirm': '确认剪枝该节点及其子树？',
  'research.inspector.convert_faded': '转化（次要）',
  'research.inspector.query': '查询',
  'research.inspector.status': '结论状态',
  'research.inspector.save_patch': '保存',
  'research.inspector.chat_placeholder': '对本节点提问…',
  'research.inspector.chat_send': '发送',
  'research.inspector.accept': '接受',
  'research.inspector.dismiss': '忽略',
  'research.plane.progress': '进度',
  'research.plane.revisions': '版本',
  'research.plane.save_revision': '保存快照',
  'research.plane.restore': '恢复',
  'research.plane.working': '工作副本',
  'research.plane.canonical': '权威报告',
  'research.plane.discard_working': '丢弃工作副本',

  'research.error.invalid_state': '当前研究状态不允许此操作',
  'research.error.budget': '研究预算已用尽',
  'research.toast.cancelled': '已取消研究任务',
  'research.toast.convert_note_success': '已转化为笔记',
  'research.toast.convert_source_success': '已转化为来源',
