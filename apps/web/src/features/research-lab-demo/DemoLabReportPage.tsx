/**
 * Demo Lab report — sessionStorage labRevisions + reportCow (xlsx-lib fixture).
 * Product report lives at `/research-lab/:nid/report` (Eden only).
 */
import {
...
export type DemoLabReportPageProps = {
  notebookId: number;
};
...
export default function DemoLabReportPage({ notebookId }: DemoLabReportPageProps) {
