...
| c24     | pipeline-integration   | 🔄 WIP (WS-A✅ / WS-C✅(非research) / WS-B拆为对齐提案)                          |
...
| c13     | distribution           | ⏸️ BLOCKED (blocked by c24 + 对齐提案)                                           |
| c14     | cleanup-delivery       | ⏸️ BLOCKED (blocked by c24 + 对齐提案)                                           |
